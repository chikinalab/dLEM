"""
Creates docs/data/example_chr10_1kb.cool from the local H1-hESC Hi-C file.

1kb-resolution counterpart to create_example_data.py, same window -- used by
docs/train_shallow_extrapolate.ipynb to compare barrier tracks across resolutions.

Run once (requires the full mcool locally):
    python docs/data/create_example_data_1kb.py

Source : H1-hESC 1 kb Hi-C (4DNFI9GMP2J8), accessed via local copy of
         /home/tis97/data2/loop_extrusion_project/4DNucleome/H1hESC.mcool
Region : chr10:19-26 Mb (7000 bins at 1 kb) -- identical genomic window to
         example_chr10.cool, just at 10x finer resolution.
...
OUT    = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'example_chr10_1kb.cool')
